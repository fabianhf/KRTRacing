...
%     data.jacStruct(data_phase.jSidx.mp.all.row,data_phase.jSidx.mp.all.col)=data.jacStruct(data_phase.jSidx.mp.all.row,data_phase.jSidx.mp.all.col)+data_phase.jacStruct(data_phase.jSidx.org.all.row,data_phase.jSidx.org.all.col);
    data.jacStruct(data_phase.jSidx.mp.XUg.row,data_phase.jSidx.mp.XUg.col)=data.jacStruct(data_phase.jSidx.mp.XUg.row,data_phase.jSidx.mp.XUg.col)+data_phase.jacStruct(data_phase.jSidx.org.XUg.row,data_phase.jSidx.org.XUg.col);
    data.jacStruct(data_phase.jSidx.mp.P.row,data_phase.jSidx.mp.P.col)=data.jacStruct(data_phase.jSidx.mp.P.row,data_phase.jSidx.mp.P.col)+data_phase.jacStruct(data_phase.jSidx.org.P.row,data_phase.jSidx.org.P.col);
    data.jacStruct(data_phase.jSidx.mp.T.row,data_phase.jSidx.mp.T.col)=data.jacStruct(data_phase.jSidx.mp.T.row,data_phase.jSidx.mp.T.col)+data_phase.jacStruct(data_phase.jSidx.org.T.row,data_phase.jSidx.org.T.col);
    data.jacStruct(data_phase.jSidx.mp.B_XUg.row,data_phase.jSidx.mp.B_XUg.col)=data.jacStruct(data_phase.jSidx.mp.B_XUg.row,data_phase.jSidx.mp.B_XUg.col)+data_phase.jacStruct(data_phase.jSidx.org.B_XUg.row,data_phase.jSidx.org.B_XUg.col);
    data.jacStruct(data_phase.jSidx.mp.B_P.row,data_phase.jSidx.mp.B_P.col)=data.jacStruct(data_phase.jSidx.mp.B_P.row,data_phase.jSidx.mp.B_P.col)+data_phase.jacStruct(data_phase.jSidx.org.B_P.row,data_phase.jSidx.org.B_P.col);
