...
t_2_r=[(linspace(0,-10,100))' sqrt(100-((linspace(0,-10,100))'+10).^2)+250]; % right racetrack boundary, segment 2
t_2_l=[(linspace(-5,-10,100))' sqrt(25-((linspace(-5,-10,100))'+10).^2)+250]; % left racetrack boundary, segment 2
t_3_r=[(linspace(-10,-260,250))' 260*ones(250,1)]; % right racetrack boundary, segment 3
t_3_l=[(linspace(-10,-260,250))' 255*ones(250,1)]; % left racetrack boundary, segment 3
