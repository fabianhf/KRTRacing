...
controls = [...
    ...
    falcon.Control('fB',    0,      15000,  1e-4, 'fixed', true);...        % falcon.Control('fB',    0,      15000,  1e-4);...
    falcon.Control('zeta',  0,      1,      1,    'fixed', true);...        % falcon.Control('zeta',  0,      1,      1);...
...
mdl.addSubsystem(@simple_vehicleModel,...                      % mdl.addSubsystem(@vehicleModel,...
    {'v','beta','psi_dot','delta','fB','zeta','phi'},...
    {'v_dot','beta_dot','psi_dot_dot','n_wheel','M_wheel','T_M'});

mdl.addSubsystem(@simple_track,...                             % mdl.addSubsystem(@track,...
    {'psi_dot','v','beta','n','xi','C','delta'},...            % {'psi_dot','v','beta','n','xi','C'},...     
    {'s_dot','n_dot','xi_dot'});
