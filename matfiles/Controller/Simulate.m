function r = Simulate(solvedProblem)
...
states = [...
    ...
    falcon.State('v',       2,      200,    1e-1);...
    falcon.State('psi_dot', -inf,   inf,   0.3);...
    falcon.State('beta',    -10/180*pi,  	10/180*pi,     1e-1);...
...
controls = [...
    ...
    falcon.Control('zeta',  0.5,    0.5,      1);...                  % falcon.Control('zeta',  0,      1,      1);...
