classdef ExplicitRungeKutta < falcon.discretization.DiscretizationMethod
    ...
    properties
        % falcon.discretization.ExplicitRungeKutta/A is a property.
        A
        % falcon.discretization.ExplicitRungeKutta/b is a property.
        b
        % falcon.discretization.ExplicitRungeKutta/c is a property.
        c
    end

    methods
        function obj = ExplicitRungeKutta(A, b, c)
        % This class represents a trapezoidal collocation method
        end
