classdef (Abstract) BaseBuilder < falcon.core.Handle
    % Creates a BaseBuilder object
    %  
    % <Syntax>
    % obj = falcon.core.builder.BaseBuilder(projectName, derivativeMode, handle,...
    %                    printLevel, optimizeCode, doHessian, parentDir)
    %  
    % <Description>
    % Implements common parts of falcon.fSimulationModelBuilder,
    % falcon.PointConstraintBuilder, falcon.PathConstraintBuilder
    %  
    % <Keywords>
    % Constructor!Base Builder
