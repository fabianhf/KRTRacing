...
COMPILER_COMMAND_FILE     = mb_vehicle_nlp_rtw_comp.rsp
CMD_FILE                  = mb_vehicle_nlp_rtw.rsp
...
DEFINES_ = -D__USE_MINGW_ANSI_STDIO=1 -DMODEL=mb_vehicle_nlp -DHAVESTDIO -DUSE_RTMODEL
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=mb_vehicle_nlp -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/mb_vehicle_nlp.cpp
...
mb_vehicle_nlp.obj : $(START_DIR)/mb_vehicle_nlp.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
